...
<header style={{background:"#fff"}} dir="rtl" className="sticky top-0 z-10 h-14 border-b border-line/50 bg-bg-base md:h-[60px]">
      ...
      <div className="p-4 md:p-6 pb-0 md:pb-0">
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-2 gap-3">
            ...
            <button className="flex h-10 items-center gap-2 rounded-md border px-[11px] py-2 text-start text-sm/none transition-colors border-primary-red bg-bg-selected text-text-selection">
              العربية
            </button>
            <button className="flex h-10 items-center gap-2 rounded-md border px-[11px] py-2 text-start text-sm/none transition-colors border-box-border bg-bg-unselected hover:border-box-border-focus dark:md:border-[#464651] dark:md:bg-[#3C3C47]">
              EN
            </button>
          </div>
          <div className="grid grid-cols-2 gap-3">
