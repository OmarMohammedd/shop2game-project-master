...
const Gamequery = () => {
    ...
    return (
        ...
        <div className='w-full h-fit flex flex-col items-end justify-end
         pr-[310px] py-8 px-5 max-[1390px]:pr-20 max-[1100px]:pr-5
         '>

<div style={{marginBottom: "-1rem"}} dir="rtl" className="mb-5 lg:mb-[28px] w-full max-w-[900px]">
...
/>
  ...
  {game === 'freefire' ? 'Free Fire' : game === 'blackclover' ? 'Black Clover M' : ''}
</div>
